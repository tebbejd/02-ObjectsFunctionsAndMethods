...
def main():
   ...
   # better_draw_circles(rg.Point(100, 50),15)
    ...
    even_better_draw_circles(rg.Point(-200, 0), 20, 10, 'green', 2)
    even_better_draw_circles(rg.Point(100, -50), 15, 3, 'blue', 5)
    even_better_draw_circles(rg.Point(400, 0), 20, 10, 'orange', 2)
    even_better_draw_circles(rg.Point(100, 400), 20, 10, 'pink', 5)
    even_better_draw_circles(rg.Point(100, -400), 20, 10, 'green', 2)
    window.update()
...
def even_better_draw_circles(point, a, b, color, thickness):
    ...
    for k in range(0, b):  # k becomes 1, 2, 3, ... 10
