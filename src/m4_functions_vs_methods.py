...
def try_methods_and_functions():
    ...
    dog.pen = rg.Pen('blue', 5)
    dog.backward(150)
    dog.speed = 1
    draw_many_squares(dog, 2, 100, 30)
    dog.speed = 5
    dog.pen.color = 'red'
    draw_many_squares(dog, 10, 50, 15)
    dog.speed = 100
    dog.pen.thickness = 35
    draw_many_squares(dog, 8, 300, 60)
    dog.pen = rg.Pen('black', 3)
    dog.backward(200)
    dog.draw_circle(30)
    dog.draw_square(50)
# -----------------------------------------------------------------------------
